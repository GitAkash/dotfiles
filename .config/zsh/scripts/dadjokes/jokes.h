const char *jokes[] = {
    ...
    "Why did the bicycle fall over?<>Because it was two-tired.",
    "What do you call a bear with no teeth?<>A gummy bear.",
    "What’s a cow’s favorite instrument?<>The mooo-sical horn.",
    ...
    "Why did the clock break up with the calendar?<>Because it needed some time apart.",
    ...
    "Why did the tomato turn to the mushroom for help?<>Because it was in a jam.",
    "Why do ducks never get into arguments?<>Because they always let things roll off their backs.",
    "Why was the belt so good at telling stories?<>Because it always had a twist.",
    "What do you call a smart group of trees?<>A brainstorm.",
    ...
    "Why did the phone go to therapy?<>It lost all its contacts.",
    "How do you catch a squirrel?<>Climb a tree and act like a nut.",
    "What do you call a fish that plays the piano?<>A tune-a fish.",
    "Why did the banana go to the doctor?<>Because it wasn’t peeling well.",
    ...
    "Why do pancakes always do well at school?<>Because they stack up well.",
    ...
    "Why did the turkey refuse to eat?<>Because it was stuffed.",
    "What do you call a lazy kangaroo?<>A pouch potato.",
    ...
    "Why did the belt go to therapy?<>It was feeling a little strapped.",
    ...
    "What do you call an owl that can code?<>Hoot-developer.",
    "Why do cows wear bells?<>Because their horns don’t work.",
    ...
    "How do you fix a broken pumpkin?<>With a pumpkin patch.",
    "Why did the frog sit on the lily pad?<>Because it was toad-ally comfortable.",
    ...
    "What do you call a dog magician?<>A labracadabrador.",
    "What did the buffalo say to his son when he left for college?<>Bison.",
    "Why did the watermelon refuse to marry?<>Because it cantaloupe.",
    "Why do cows make great musicians?<>Because they have perfect moosic timing.",
    "What do you call a dog on the beach?<>A hot dog.",
